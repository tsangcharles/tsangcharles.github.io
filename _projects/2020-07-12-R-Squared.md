...
I used the support vector regression package in Python and observed that $$SST = 22 > 15.07 = SSE + SSR$$. More details can be found in my [script](https://github.com/tsangcharles/R-Squared/blob/master/main.py).
