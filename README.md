# Charles Tsang's Personal Website

This is the source code for my personal website built with [Jekyll](https://jekyllrb.com/).

## Table Of Contents

<!--ts-->

- [Charles Tsang's Personal Website](#charles-tsangs-personal-website)
...
This site comes with stylish layouts for pages and blog posts.
...
Photo formatting is made simple using [Bootstrap's grid system](https://getbootstrap.com/docs/4.4/layout/grid/). Easily create beautiful grids within your blog posts and project pages, also with support for video and audio embeds.
...
This site supports preview images on social media. To enable this functionality you will need to set `serve_og_meta` to `true` in your [\_config.yml](_config.yml). Once you have done so, all your site's pages will include Open Graph data in the HTML head element.
...
This website is based on the [al-folio](https://github.com/alshedivat/al-folio) Jekyll theme, available under the [MIT License](LICENSE).
